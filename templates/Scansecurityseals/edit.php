...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $scansecurityseal->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $scansecurityseal->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="scansecurityseals form content">
            ...
            <fieldset>
                <legend><?= __('Edit Scansecurityseal') ?></legend>
                <?php

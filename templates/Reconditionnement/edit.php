...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $reconditionnement->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $reconditionnement->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="reconditionnement form content">
            ...
            <fieldset>
                <legend><?= __('Edit Reconditionnement') ?></legend>
                <?php
